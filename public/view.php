...
if (isset($_POST['regenerate'])) {
    $stmt_upd = $pdo->prepare("UPDATE videos SET status = 'ready_for_render' WHERE id = ?");
    $stmt_upd->execute([$video_id]);
...
<head>
    ...
    <style>
        ...
        .btn-regen { background: #333; color: #fff; }
        .btn-regen:hover { background: #444; }
                ...
                <div style="padding: 1rem; background: #1a1a1a;">
                    <div class="action-btns">
                        ...
                        <form method="POST" style="flex:1; display:flex;">
                            <button type="submit" name="regenerate" class="btn-action btn-regen">
                                🔄 Regenerare
                            </button>
                        </form>
                    </div>
            ...
            <div class="resources-panel">
                ...
                <div class="meta-card">
                    <div class="meta-header">
                        <h3>Titlu Video</h3>
                        <button class="copy-btn" onclick="copyToClipboard('titleField')">Copy</button>
                    </div>
                ...
                <div class="meta-card">
                    <div class="meta-header">
                        ...
                        <button class="copy-btn" onclick="copyToClipboard('scriptField')">Copy</button>
                    </div>
                    <div class="field-group">
                ...
                <div class="meta-card">
                    <div class="meta-header">
                        <h3>Descriere SEO & Hashtags</h3>
                        <button class="copy-btn" onclick="copyToClipboard('descField')">Copy All</button>
                    </div>
                    <div class="field-group">
                        <textarea id="descField" rows="8" readonly><?php
                            echo htmlspecialchars($video['description'] ?: $placeholder);
                            echo "\n\n" . htmlspecialchars($video['tags'] ?: '');
                        ?></textarea>
                    </div>
                </div>
